...
allowed-tools: Bash(/opt/homebrew/bin/python3:*)
---

Run the loopx setup helper and read its output:

!`/opt/homebrew/bin/python3 "/Users/amd/.local/share/uv/tools/loopx/lib/python3.12/site-packages/loopx/claude_goal_mode/scripts/goalmode_cmd.py" $ARGUMENTS`
